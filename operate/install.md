...
Now that you've got your node up and running, review [wallet verification ](./#discord-verification)and then review the [monitoring guide](monitoring-stack.md) for how to set up a monitoring stack to view and monitor your node's performance.
